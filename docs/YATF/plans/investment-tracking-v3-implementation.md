...
- [[features/investment-tracking]] — V1 base
- [[features/multi-broker-architecture]] — V2 multi-broker foundation
- [[features/historical-snapshots]] — V2 snapshot persistence (needed for performance prefill)
- [[features/crud-etf-transactions]] — Transaction edit/delete patterns
...
- [[features/investment-tracking-v3]] — feature page
