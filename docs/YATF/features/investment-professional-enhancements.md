...
related: ["features/investment-tracking", "features/investment-tracking-v3", "features/multi-broker-architecture", "bugs/ticker-persistence", "features/financial-projections"]
---
...
- [[bugs/ticker-persistence]] — Blocking bug that should be fixed before or alongside these enhancements
- [[features/investment-tracking-v3]] — V3 already added dividends, tax pocket, cash adjustments, CAGR
- [[features/multi-broker-architecture]] — V2 multi-broker foundation
- [[features/financial-projections]] — Projections page (privacy mode affects this too)
