...
updated: 2026-07-03
status: implemented
sources: ["raw/sidebar-routing-refactor.md"]
...
- [[features/sidebar-redesign]] — Previous sidebar work (vertical layout, collapsible mode)
- [[features/investment-tracking-guide]] — User guide for investment/projection features (now under `/investments`)
