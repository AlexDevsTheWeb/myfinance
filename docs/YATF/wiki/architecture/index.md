...
System architecture, component diagrams, data flow, and tech stack.

## Pages

| Concept | Description |
|---------|-------------|
| [[architecture/codebase-structure|codebase-structure]] | Directory layout, file naming conventions, and source organization. |
| [[architecture/concerns-and-tech-debt|concerns-and-tech-debt]] | Known tech debt, open bugs, security gaps, and performance concerns. |
