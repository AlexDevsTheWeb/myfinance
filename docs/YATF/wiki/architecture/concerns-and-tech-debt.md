...
| Backup/restore missing budget + investment data (6 entities) | Export/import loses budget config, broker accounts, holdings, cash adjustments, dividends | ✅ Fixed — see [[wiki/plans/backup-restore-data-coverage]] |
