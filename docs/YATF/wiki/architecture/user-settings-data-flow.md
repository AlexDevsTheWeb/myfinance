...
- [[wiki/features/user-configurable-rates/user-configurable-rates]] — Feature spec (implemented)
- [[wiki/plans/user-configurable-rates-implementation]] — Implementation plan (completed)
- [[wiki/features/tax-inflation-modeling/tax-inflation-modeling]] — Current implementation (updated)
- [[wiki/features/financial-projections/financial-projections]] — Consumer of settings
- [[wiki/architecture/financial-projections-architecture]] — Projections architecture
- [[wiki/architecture/external-integrations]] — Firebase config
