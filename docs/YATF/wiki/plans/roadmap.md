...
- **Plan:** [[wiki/plans/backup-restore-data-coverage]] — audit found 6 missing entities (budget + investment data)
...
- **Plan:** [[wiki/plans/05-01-google-drive-backup]] (not yet created)
...
- **Plan:** [[wiki/plans/investment-tracking-implementation]]
