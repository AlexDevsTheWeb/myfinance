...
resource: "https://github.com/AlexDevsTheWeb/myfinance/issues/93"
title: "Financial Projections — Smart Tax & Inflation Modeling"
tags: [feature, projections, tax, inflation, implemented]
created: 2026-06-27
updated: 2026-06-27
status: implemented
sources: ["raw/93-tax-inflation/93-tax-inflation.md", "raw/12-investment-tracking-v2/implementation.md"]
...
The current implementation uses a hardcoded 2% inflation rate. A proposed enhancement [[wiki/features/user-configurable-rates/user-configurable-rates]] would make inflation and tax rates user-configurable via a settings page, replacing the hardcoded constants with per-user stored values.

## Related

- [[wiki/features/user-configurable-rates/user-configurable-rates]] — Proposed: user-configurable rates (next evolution)
