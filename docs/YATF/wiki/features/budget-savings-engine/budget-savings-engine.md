...
- [[wiki/features/investment-tracking/investment-tracking]] — Investment pipeline, target for surplus routing
- [[wiki/features/financial-projections/financial-projections]] — Projections simulation fed by savings rate data
- [[wiki/features/crud-etf-transactions/crud-etf-transactions]] — Transaction patterns
