...
- [[wiki/features/investment-tracking/investment-tracking]] — Investment pipeline (surplus target)
- [[wiki/features/financial-projections/financial-projections]] — Projections (savings rate consumer)
- [[wiki/architecture/system-architecture]] — Overall system architecture
- [[wiki/architecture/investment-tracking-architecture]] — Investment architecture
- [[wiki/architecture/financial-projections-architecture]] — Projections architecture
- [[wiki/plans/budget-savings-engine-implementation]] — Implementation plan
