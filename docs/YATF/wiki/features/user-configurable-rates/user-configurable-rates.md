...
- [[wiki/features/tax-inflation-modeling/tax-inflation-modeling]] — Current inflation toggle (now uses configured rate)
- [[wiki/features/financial-projections/financial-projections]] — Projections page that consumes the rates
- [[wiki/architecture/user-settings-data-flow]] — Settings architecture, Firestore schema, store design
- [[wiki/plans/user-configurable-rates-implementation]] — Task breakdown
- [[wiki/architecture/financial-projections-architecture]] — Projections architecture (updated)
- Source: [raw/103/103.md](raw/103/103.md)
