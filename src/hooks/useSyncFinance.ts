...
export const useSyncFinance = () => {
  ...
  useEffect(() => {
    ...
    // Check if user document exists and initialize if needed
    const initializeUser = async () => {
      ...
      try {
        ...
        if (!docSnap.exists()) {
          // New user - create default configuration
          console.log('New user detected, initializing with default configuration...');
